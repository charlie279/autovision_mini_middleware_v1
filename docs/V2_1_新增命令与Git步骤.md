# V2.1 CamMW Transport Bridge 新增命令与 Git 步骤

## 1. 版本定位

V2.1 以 AutoVision Mini Middleware V2.0 为基准，不破坏 V2.0 已有 media/preprocess/NPU/algorithm/encode/control/safety 主线。新增内容聚焦 CamMW v4.7.2 中最值得迁移到 AutoVision 的工程能力：大 payload 安全边界、QoS msg_size/depth、四链路 Test/Raw/Encoded/Lidar schema 与可复现验证。
...
git commit -m "v2.1-step1: add CamMW-style local transport schema and backend"
